...
void main ()
{
  ...
  tmpvar_2.xy = ((tmpvar_3.xy + tmpvar_3.w) * 0.500000);
...
void main ()
{
  ...
  mediump vec2 bump_4;
  lowp vec2 tmpvar_5;
  tmpvar_5 = ((texture2D (_BumpMap, xlv_TEXCOORD1).xyz * 2.00000) - 1.00000).xy;
  bump_4 = tmpvar_5;
...
void main ()
{
  ...
  mediump vec2 bump_4;
  lowp vec3 normal_5;
  normal_5.xy = ((texture2D (_BumpMap, xlv_TEXCOORD1).wy * 2.00000) - 1.00000);
